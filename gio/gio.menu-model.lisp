...
(define-g-object-class "GMenuModel" menu-model
...
(setf (documentation 'menu-model 'type)
 "@version{#2022-12-30}
  ...
  and link types have names: \"label\", \"action\", \"target\", \"section\",
  and \"submenu\".
...
#+liber-documentation
(setf (liber:alias-for-variable '+g-menu-attribute-action+) "Constant")
...
(defparameter +g-menu-attribute-action+ "action"
 ...
 "@version{#2021-9-3}
  ...
  See also the @fun{menu-model-get-item-attribute} and
  @fun{menu-item-set-attribute} functions.
  @see-class{menu-model}
  @see-function{menu-model-get-item-attribute}
  @see-function{menu-item-set-attribute}")
...
#+liber-documentation
(setf (liber:alias-for-variable '+g-menu-attribute-target+) "Constant")
...
(defparameter +g-menu-attribute-target+ "target"
 ...
 "@version{#2021-4-15}
  ...
  @begin{short}
    ...
    will be activated.
  @end{short}
  See also the function @fun{menu-item-set-action-and-target}.
  @see-class{menu-model}
  @see-function{menu-item-set-action-and-target}")
...
#+liber-documentation
(setf (liber:alias-for-variable '+g-menu-attribute-label+) "Constant")
...
#+liber-documentation
(setf (liber:alias-for-variable '+g-menu-link-section+) "Constant")
...
(defparameter +g-menu-link-section+ "section"
 ...
 "@version{#2021-4-15}
  ...
  item's label as a header. See also the function @fun{menu-item-link}.
  @see-class{menu-model}
  @see-function{menu-item-link}")
...
#+liber-documentation
(setf (liber:alias-for-variable '+g-menu-link-submenu+) "Constant")
...
(defparameter +g-menu-link-submenu+ "submenu"
 ...
 "@version{#2021-4-15}
  ...
  @end{short}
  See also the function @fun{menu-item-link}.
  @see-class{menu-model}
  @see-function{menu-item-link}")
...
(defcfun ("g_menu_model_is_mutable" menu-model-is-mutable) :boolean
 #+liber-documentation
 "@version{#2022-12-30}
...
;;; ----------------------------------------------------------------------------
;;; g_menu_model_get_n_items () -> menu-model-n-items
;;; ----------------------------------------------------------------------------

(defcfun ("g_menu_model_get_n_items" menu-model-n-items) :int
 #+liber-documentation
 "@version{#2022-12-30}
  @argument[model]{a @class{g:menu-model} object}
