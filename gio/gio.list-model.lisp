...
(define-g-interface "GListModel" list-model
  (:export t
...
(defcfun ("g_list_model_get_item_type" list-model-item-type) gobject:type-t
 #+liber-documentation
 "@version{#2022-12-31}
...
(defcfun ("g_list_model_get_n_items" list-model-n-items) :uint
 #+liber-documentation
 "@version{#2022-12-31}
  @argument[list]{a @class{g:list-model} object}
...
(defcfun ("g_list_model_get_item" list-model-item) :pointer
 #+liber-documentation
 "@version{#2022-12-31}
  @argument[list]{a @class{g:list-model} object}
...
(defcfun ("g_list_model_get_object" list-model-object) gobject:object
 #+liber-documentation
 "@version{#2022-12-31}
  @argument[list]{a @class{g:list-model} object}
  @argument[position]{an unsigned integer with the position of the item to
...
(defcfun ("g_list_model_items_changed" list-model-items-changed) :void
 #+liber-documentation
 "@version{#2022-12-31}
  @argument[list]{a @class{g:list-model} object}
