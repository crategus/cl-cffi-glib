...
(define-g-object-class "GThemedIcon" themed-icon
...
(defcfun ("g_themed_icon_prepend_name" themed-icon-prepend-name) :void
 #+liber-documentation
 "@version{#2022-12-29}
...
(defcfun ("g_themed_icon_append_name" themed-icon-append-name) :void
 #+liber-documentation
 "@version{#2022-12-29}
  @argument[icon]{a @class{g:themed-icon} object}
