...
#+liber-documentation
(setf (liber:alias-for-symbol 'filesystem-preview-type)
      "GEnum"
...
(setf (liber:alias-for-class 'file)
 ...
 "@version{2022-12-27}
  ...
  Linux. If you want to check if two @sym{g:file} objects point to the same file
  ...
  simply have @code{_async} appended to their function names. The asynchronous
...
(defcfun ("g_file_new_for_uri" file-new-for-uri) (gobject:object file)
 ...
 "@version{2022-12-27}
  ...
  @return{A new @class{g:file} object for the given @arg{uri}.}
  @begin{short}
...
(defcfun ("g_file_parse_name" file-parse-name) (gobject:object file)
 ...
 "@version{2022-12-27}
  ...
  @return{A new @class{g:file} object.}
  @begin{short}
    Constructs a @class{g:file} object with the given @arg{parsename}, i.e.
...
(defcfun ("g_file_get_uri" file-uri) (:string :free-from-foreign t)
 ...
 "@version{2022-12-27}
  @argument[file]{an input @class{g:file} object}
  @begin{return}
    A string containing the @class{g:file} URI, or @code{nil} if no such path
    exists.
  @end{return}
  @begin{short}
    Gets the local pathname for @arg{file}, if one exists.
