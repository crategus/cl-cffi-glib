...
#+liber-documentation
(setf (liber:alias-for-symbol 'closure)
      "CStruct"
      (liber:symbol-documentation 'closure)
 "@version{#2022-12-29}
  @begin{short}
...
(defcfun ("g_closure_get_type" type-closure) type-t
 #+liber-documentation
 "@version{#2022-12-29}
  @begin{short}
...
(defcfun ("g_closure_ref" closure-ref) (:pointer (:struct closure))
 #+liber-documentation
 "@version{#2013-6-12}
...
(defcfun ("g_closure_sink" closure-sink) :void
 #+liber-documentation
 "@version{#2013-6-12}
  ...
  initial reference count is not owned by any caller. The @sym{closure-sink}
  ...
  floating, the @fun{closure-sink} function does nothing. The reason for the
  ...
  @end{pre}
  Because the @fun{source-set-closure} function (and similar functions) take
  ownership of the initial reference count, if it is unowned, we instead can
  write:
  @begin{pre}
   g_source_set_closure (source, g_cclosure_new (cb_func, cb_data));
  @end{pre}
  Generally, this function is used together with the @fun{closure-ref}
  ...
  @begin{pre}
   ...
   @}
  @end{pre}
  Because the @sym{closure-sink} may decrement the reference count of a
  closure (if it has not been called on closure yet) just like the functions
  @fun{closure-unref}, @fun{closure-ref} should be called prior to this
  function."
  (closure (:pointer (:struct closure))))
...
(defcfun ("g_closure_unref" closure-unref) :void
 #+liber-documentation
 "@version{#2013-6-12}
...
(defcfun ("g_closure_invalidate" closure-invalidate) :void
 #+liber-documentation
 "@version{#2013-6-12}
  ...
  @sym{closure-invalidate} function, make sure that you have previously
  called the @fun{closure-ref} function.

  Note that the @sym{closure-invalidate} function will also be called when the
...
(defcfun ("g_closure_add_finalize_notifier" closure-add-finalize-notifier)
    :void
 #+liber-documentation
 "@version{#2013-6-12}
  ...
  order. If a single call to the @fun{closure-unref} function results in the
...
(defcfun ("g_closure_add_invalidate_notifier" closure-add-invalidate-notifier)
    :void
 #+liber-documentation
 "@version{#2013-6-12}
  @argument[closure]{a @symbol{closure}}
  ...
  @begin{short}
    ...
    invalidated with the @fun{closure-invalidate} function.
  @end{short}
...
(defcfun ("g_closure_new_simple" closure-new-simple)
 ...
 "@version{#2013-6-12}
  ...
  @argument[data]{data to store in the data field of the newly allocated
    @symbol{closure}}
  @return{A newly allocated @symbol{closure}.}
  @begin{short}
...
(defcfun ("g_closure_set_marshal" closure-set-marshal) :void
 #+liber-documentation
 "@version{#2013-6-12}
  @argument[closure]{a @symbol{closure}}
  ...
  @fun{closure-set-meta-marshal}.) For GObject's C predefined marshallers
